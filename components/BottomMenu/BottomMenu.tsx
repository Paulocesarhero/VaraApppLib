  ...
  return (
    <View style={[BottomMenuStyle.container, BottomMenuStyle.containerBottom]}>
      <MenuItem
        ...
        imageSource={require("../../src/assets/format.imageset/format.png")}
        label="Stranding"
      />
      <MenuItem
        onPress={handleRecommendationsPress}
        style={[ViewStyleRecommendations, getStyle("Recommendations")]}
        imageSource={require("../../src/assets/recommendation.imageset/recommendation.png")}
        label="Recommendations"
      />
      <MenuItem
        onPress={handleSettingsPress}
        style={[ViewStyleSettings, getStyle("Settings")]}
        imageSource={require("../../src/assets/settings.imageset/settings.png")}
        label="Settings"
      />
    </View>
  );
