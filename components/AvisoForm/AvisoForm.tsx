...
export const AvisoForm: React.FC<AvisoFormProps & { showEspecie?: boolean }> = ({
    onSubmitData,
    loading,
    setLoading,
    showEspecie = false,
                        ...
                        render={({ field: { value } }) => (
                            <DateSelector
                                ...
                                onDateChange={(selectedDate: Date) => {
                                    const formattedDate = selectedDate.toISOString().split('T')[0]; // Formateo para que sea como el API: YYYY-MM-DD
